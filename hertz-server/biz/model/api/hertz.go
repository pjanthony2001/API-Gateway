...
type Response struct {
	...
	Flag    int32  `thrift:"Flag,2" form:"Flag" json:"Flag" query:"Flag"`
}
...
func (p *Response) GetFlag() (v int32) {
	return p.Flag
}
...
func (p *Response) writeField2(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteI32(p.Flag); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *Request) GetFlag() (v int32) {
	return p.Flag
}
